...
public class ObjectGeneratorTest extends GeneratorTestCase {
    @Test
    @Parameters
    ...
    private List<Object[]> parametersForFromObjectArrayWithLimit() {
        return paramsList(params(StringArray.of("abc: ()"), "abc", new String[]{}, 1),
                ...
                params(StringArray.of("abc: null"), "abc", null, 1),
    ...
    private List<Object[]> parametersForFromExceptionWithLimit() {
        ...
        return paramsList(params(StringArray.of("java.lang.Exception: abc"), "def", t, 0),
                params(StringArray.of("java.lang.Exception: abc",
                        "def[0]: org.quamat.gen.ExampleException.createException(ExampleException.java:9)"), "def", t, 1),
                params(StringArray.of("java.lang.Exception: abc",
                        "def[0]: org.quamat.gen.ExampleException.createException(ExampleException.java:9)",
                        "def[1]: org.quamat.gen.ExampleException.createNestedException(ExampleException.java:5)"), "def", t, 2));
    }
    ...
    private List<Object[]> parametersForFromExceptionWithoutLimit() {
        ...
        return paramsList(params(StringArray.of("java.lang.Exception: abc",
                "def[0]: org.quamat.gen.ExampleException.createException(ExampleException.java:9)",
                "def[1]: org.quamat.gen.ExampleException.createNestedException(ExampleException.java:5)"), "def", t));
    }
    ...
    private List<Object[]> parametersForRecursion() {
        ...
        // ignore warning about Arrays.hashCode() -- the test is hardwired for obj.hashCode()
