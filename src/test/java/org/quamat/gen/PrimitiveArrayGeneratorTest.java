...
public class PrimitiveArrayGeneratorTest extends GeneratorTestCase {
    ...
    private PrimitiveArrayGenerator generator;

    @Before
    public void setup() {
        result = StringArray.empty();
        generator = createPrimitiveArrayGenerator(result);
    }
    ...
    public void fromArray(StringArray expected, String key, Object value) {
        generator.generateArray(key, value);
        assertThat(result, equalTo(expected));
    }

    private List<Object[]> parametersForFromArray() {
